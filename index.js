...
const menuItem1 = createMenuItem("pizza",5,"lunch");
const menuItem2 = createMenuItem("french fries",3,"appetizer");
const menuItem3 = createMenuItem("buffalo chicken wings",7,"appetizer");

console.log(menuItem1); console.log(menuItem2); console.log(menuItem3);
...
function getReviewByRating(array, rate) {
  let starRate = array.filter(function(e){
    return e.rating >= rate && e.rating <= rate+1
  });
  return (starRate)
}  
// Keep console.log for proof of completion  
...
function getLongReviews(array){
  ...
  for (let i = 0; i < array.length; i++){
    let splitFeedback=array[i].feedback.split(' ');
    if(splitFeedback.length > 15){
